<div class="well col-xs-12 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2  col-lg-6 col-lg-offset-3">
    <h2 class="text-center">Nueva Fianza</h2>
    {{ Form::open(array('url'=>'licitaciones/nuevafianza','method'=>'POST')) }}
    ...
    <div class="form-group ">
        ...
        <a href="{{ URL::to('licitaciones/nuevo',$id) }}" class="btn btn-warning col-xs-4 col-xs-offset-1">Cancelar</a>
    </div>
    {{ Form::close() }}
</div>
