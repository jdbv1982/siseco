...
class Seguimiento extends \Eloquent{
	public $errores;
	protected $fillable = array('comentarios','concejecutar','observaciones','codigoaccion','observacionesseg','ninforme','idclasseguimiento','idsubclasseguimiento','idfondoseguimiento');
